...
const data = [
  {
    id: 1,
    title: "Build your own digital platform",
    text: "Our platform happens to be a given support such as building website, social media pages, etc. within few mins in a hassle free manner.",
  },
  {
    id: 2,
    title: "Strong and Easy networking",
    text: "A decent network to female business which help them for arising their image in the market under the best supervision.",
  },
  {
    id: 3,
    title: "Grow your Business locally",
    text: "Additionally, the business would start growing by attracting the local customers and then expanding it globally.",
  },
];
