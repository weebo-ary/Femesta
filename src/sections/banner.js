      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          <Heading as="h1" variant="heroPrimary">
            Get your personal Mentorship without any Formalities
          </Heading>
          <Text as="p" variant="heroSecondary">
            The multichannel engagement platform which allows the women entrepreneur
            to get an instant personal Mentorship !
          </Text>
          <Subscribe />
        </Box>
