...
const data = {
  ...
  description:
    "The multichannel engagement platform which automates personal email outreach, calls, and tasks, while women can easily focus on the mentorship.",
